...
async function connectToDb() {
    try {
        await mongoose.connect('mongodb+srv://Priya:Priya@cluster.jb7qcju.mongodb.net/Swiggy?retryWrites=true&w=majority')
...
connectToDb()
app.post('/add-restaurant-details', async function(request, response) {
    try {
